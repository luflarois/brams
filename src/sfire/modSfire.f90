...
! Gathering Data
      ...
      !print*,npatch
      !    print*,"passei DN0"
      print *, "SFIRE - sou", mynum, "  e estou depois do gather data"; call flush (6)
...
! temp_topt(:,:)=60.0
         ...
         print *,'LFR-DBG: voltei do sfire_driver_em_step'; call flush(6)
         ...
         print *, 'LFR-DBG: somando ao calor do  Jules'; call flush(6)
         ...
         !print*,sfire_g%grnqfx
         print *, 'LFR-DBG: fim do setor serial'; call flush (6)
      end if
      CALL Broadcast(mynum, master_num, "sync")
      print *, 'LFR-DBG: ',mynum,'Saindo do setor serial'; call flush (6)
...
!!!!!   call Broadcast(temp_sflux_r, master_num,   'temp_sflux_r' )
   ...
   subroutine swap_sfire_brams(temp_sflux_t, temp_sflux_r, &
      ...
      !         n2, master_num)
      print *,"LFR-DBG: dentro do swap - antes do mkbuff sflux_t"
      call flush (6)
      ! Distributing local information about sensible heat
      print *,'LFR-DBG: ',mynum,'Distributing local information about sensible heat'
      print *,'LFR-DBG: ',n1,n2,nodemxp(mynum, 1),nodemyp(mynum, 1),ia,iz,ja,jz
      print *,'LFR-DBG: ',size(temp_sflux_t,1),size(temp_sflux_t,2)
      print *,'LFR-DBG: ',size(said_sflux_t,1),size(said_sflux_t,2)
      call flush(6)
