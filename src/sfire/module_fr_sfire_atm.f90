...
993   format(3a, 4(1x, i3, ':', i3))
   ...
   subroutine fire_tendency( &
      ...
      real, dimension(ids:ide, kds:kde, jds:jde) :: hfx, qfx
      ...
      call print_2d_stats(ids, ide, jds, jde, ims, ime, jms, jme, grnhfx, 'fire_tendency:grnhfx')
      call print_2d_stats(ids, ide, jds, jde, ims, ime, jms, jme, grnqfx, 'fire_tendency:grnqfx')
      ...
      call print_3d_stats(ids, ide, kds, kde, jds, jde, ims, ime, kms, kme, jms, jme, rthfrten, 'fire_tendency:rthfrten')
      call print_3d_stats(ids, ide, kds, kde, jds, jde, ims, ime, kms, kme, jms, jme, rqvfrten, 'fire_tendency:rqvfrten')
   ...
   subroutine interpolate_atm2fire(id, &
      ...
      character(len=256)::msg
      real, dimension(ids:ide,jds:jde):: ua, va
      real, dimension(ids:ide, kds:kde, jds:jde):: altw, altub, altvb, hgtu, hgtv
      ...
      call print_3d_stats(ids, ite1, kds, kde, jds, jde,ims, ime, kms, kme, jms, jme, u, 'wind U in')
      call print_3d_stats(ids, ide, kds, kde, jds, jte1,ims, ime, kms, kme, jms, jme, v, 'wind V in')
...
11             continue
     ...
     !                           ua)
      ...
      !LFR call print_2d_stats(itsou, iteou, jtsou, jteou, ids - 2, ide + 2, jds - 2, jde + 2, ua, msg)
      !write (msg, 12) 'atm mesh wind V at', fire_wind_height, ' m'
      !LFR call print_2d_stats(itsov, iteov, jtsov, jteov, ids - 2, ide + 2, jds - 2, jde + 2, va, msg)
!12    format(a, f6.2, a)
      ...
      !ESTA ROTINA NÃO ESTA COM INDICES CORRECTOS
...
!print*,"sai da rotina windrf"
   ...
   subroutine setup_wind_log_interpolation( &
      ...
      call print_2d_stats(ifds, ifde, jfds, jfde,ifms, ifme, jfms, jfme, fz0, 'setup_wind_log:fz0')
      call print_2d_stats(ifds, ifde, jfds, jfde,ifms, ifme, jfms, jfme, fz0, 'setup_wind_log:fwh')
   ...
   subroutine interpolate_wind2fire_height(id, &
      ...
      real, dimension(ids - 1:ide + 1, kds:kde, jds - 1:jde + 1)::z, zw
      character(len=128)::msg
         ...
         loop_i: do i = iftst, iftet
            ...
            if (wh > z0 .and. z0 > 0) then
               ...
               loop_k: do k = kds, kdmax
                  ...
                  ht = interpolate_h(ids, ide, kds, kde, jds, jde, icm, k, jcm, wicm, wjcm, z)
